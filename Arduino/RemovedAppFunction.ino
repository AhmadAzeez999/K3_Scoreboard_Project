...
//clearing all the athlete related functions void setName(char *athName);
//void setPlace(char *athPlace);
//void displayHighJump(char *p);
//void scrollAndPauseBig(char *m, uint8_t scrollLength, char scrollPrevious);
//void setResultSm(char *r);
//void setResultLg(char *r);
//setHeight(char *hgt)
//static inline void setXXX(char *x)
//static inline void setResultSm(char *r)
//static inline void setResultLg(char *r)
//static inline void setHjLg(char *r)
//static inline void sendMsg20() 
//static inline void sendMsg6()
//static inline void sendHjLg()
//void clearXXX()
//void clearHeight()
//void copyMsg20()

//static inline void fromFL() this is dome fieldlynx code
//fieldlynx is sending countdown data/time data
//removed the web code for noew, will deal latter
//static inline void fromWeb() removed the web code to make life easier for now
